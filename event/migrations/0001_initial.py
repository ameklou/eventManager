    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True, verbose_name='event creation date')),
                ('available_place', models.CharField(max_length=10, verbose_name='available places')),
